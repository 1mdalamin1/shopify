jQuery(document).ready(function($) {
    function populateCartDrawer(items) {
        ...
        $.each(items, function(index, item){
            ...
            $("#cart-items").append(`
                 <div class="m-6 single_cart_list">
                    ...
                    <div class="flex border-b border-[#F0EEED] pb-6 mt-6 border_none">
                        <div class="w-2/12">
                        <div class="p-4 bg-[#F0EEED] rounded-2xl mr-6">
                            <img src="${item.image}" alt="">
                        </div>
                        </div>
                        <div class="w-8/12 cart-font">
                        ...
                        <div class="w-2/12">
                            <div class="">
                                    <div class="flex justify-end">
                                        <button data-item-id="${item.id}" class="cursor-pointer remove-item-from-cart" type="button">
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            populateCartDrawer(response.items);
